...
public class LogTaskFactory {
    ...
    private static LoginLogMapper loginLogMapper = ApplicationContextHelper.getBean(LoginLogMapper.class);
    private static OperationLogMapper operationLogMapper = ApplicationContextHelper.getBean(OperationLogMapper.class);
