...
public class OkoooPageCreator
{
	...
	static
	{
		...
		PAGE_PRIORITIES.put(PAGE_BD_SCORE, 3500.0);
		PAGE_PRIORITIES.put(PAGE_ODDS_OP, 1000.0);
		PAGE_PRIORITIES.put(PAGE_ODDS_YP, 1000.0);
		PAGE_PRIORITIES.put(PAGE_ODDS_OP_CHILD, 1000.0);
		PAGE_PRIORITIES.put(PAGE_ODDS_YP_CHILD, 1000.0);
		...
		PAGE_BASE_URLS.put(PAGE_BD_SCORE, 			"http://www.okooo.com/danchang/bifen/");
