...
public class ZgzcwPageCreator
{
	...
	{		
		{SoccerConstants.MATCH_TYPE_LEAGUE, 	"http://saishi.zgzcw.com/summary/liansaiAjax.action" }, // ?source_league_id=8&currentRound=3&season=2017-2018&seasonType=";//联赛类型的数据
		{SoccerConstants.MATCH_TYPE_CUP,    	"http://saishi.zgzcw.com/soccer/"},  	// "cup/51/2017-2018/" 杯赛类型的数据
		{SoccerConstants.LOTTERY_BD,        	"http://cp.zgzcw.com/lottery/bdplayvsforJsp.action?lotteryId=200"}, // &issue=80401 // 北单足彩
		{SoccerConstants.LOTTERY_JC,        	"http://cp.zgzcw.com/lottery/jchtplayvsForJsp.action?lotteryId=47&type=jcmini"}, // &issue=2018-03-25 // 竞彩足球
		{SoccerConstants.LOTTERY_ZC,        	"http://cp.zgzcw.com/lottery/zcplayvs.action?lotteryId=13"}, // &issue=300&v=2018-02-22" 足彩足球
		{SoccerConstants.ODDS_TYPE_OP,      	"http://fenxi.zgzcw.com/"}, 			// 2249815/bjop /mid/bjop
		{SoccerConstants.ODDS_TYPE_YP,      	"http://fenxi.zgzcw.com/"}, 			// 2249815/ypdb /mid/ypdb
		...
		{"center",                          	"http://saishi.zgzcw.com/soccer/"}, 	// 数据主页面
