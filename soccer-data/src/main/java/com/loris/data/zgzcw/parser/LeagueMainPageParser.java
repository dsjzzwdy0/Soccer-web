...
public class LeagueMainPageParser extends AbstractWebPageParser
{
	...
	/**
	 *  (non-Javadoc)
	 * @see com.loris.client.parser.impl.AbstractWebPageParser#parse(com.loris.client.page.WebPage, org.jsoup.nodes.Document, com.loris.client.parser.WebPageResults)
	 */
	@Override
