 ...
 */
package com.loris.data.service.impl;

import org.apache.log4j.Logger;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import com.loris.data.service.SoccerDataService;
...
public class SoccerServiceImpl implements SoccerDataService
{
	...
	/**
	 * 保存数据页面解析得到的内容
	 * @see com.loris.data.service.SoccerDataService#saveSoccerDataRecords(com.loris.soccer.wrapper.TableRecords)
	 */
