        ...
        <div class="form-horizontal" id="menuInfoForm">
            ...
            <div class="row">
                <div class="col-sm-6 b-r">
                    <fns:input id="name" name="名称" value="${menu.name}" underline="true" />
                    <fns:input id="code" name="菜单编号" value="${menu.code}" underline="true" />
                    <fns:input id="pcodeName" name="父级编号" value="${menu.pcodeName}" underline="true"
                ...
                <div class="col-sm-6">
                    <fns:input id="url" name="请求地址" value="${menu.url}" underline="true" />
                    <fns:input id="num" name="排序" value="${menu.num}" underline="true" />
                    <fns:input id="icon" name="图标" underline="false" value="${menu.icon}"/>
                </div>
            </div>

            <div class="row btn-group-m-t">
                <div class="col-sm-10">
                    <fns:button btnCss="info" name="提交" id="ensure" icon="fa-check" clickFun="MenuInfoDlg.editSubmit()"/>
...
<script src="${content}/static/modular/system/menu/menu_info.js"></script>
