		...
		<div class="form-horizontal" id="roleInfoForm">
			...
			<div class="row">
				<div class="col-sm-6 b-r">
					<fns:input id="name" name="角色名称" underline="true" value="${role.name}"/>
					<fns:input id="pName" name="上级名称" underline="true" hidden="pid" hiddenValue="${role.pid}" readonly="readonly" value="${pName}"
							clickFun="RolInfoDlg.showPNameSelectTree(); return false;"
							style="background-color: #ffffff !important;"/>
					<fns:input id="deptName" name="部门名称" hidden="deptid" hiddenValue="${role.deptid}" readonly="readonly" value="${deptName}"
							clickFun="RolInfoDlg.showDeptSelectTree(); return false;"
							style="background-color: #ffffff !important;"/>
				</div>
				<div class="col-sm-6">
					<fns:input id="tips" name="别名" underline="true" value="${role.tips}"/>
					<fns:input id="num" name="排序" value="${role.num}"/>
				</div>
			</div>
			...
			<div class="row btn-group-m-t">
				<div class="col-sm-10">
					<fns:button btnCss="info" name="提交" id="ensure" icon="fa-check" clickFun="RolInfoDlg.editSubmit()"/>
