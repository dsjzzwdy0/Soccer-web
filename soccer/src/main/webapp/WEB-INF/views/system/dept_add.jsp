...
<%@ page import="com.loris.auth.security.ShiroKit" %>
        ...
        <div class="form-horizontal" id="deptInfoForm">
            ...
            <div class="row">
                <div class="col-sm-6 b-r">
                    <fns:input id="simplename" name="部门名称" underline="true"/>

                    <fns:input id="fullname" name="部门全称" underline="true"/>

                    <fns:input id="tips" name="备注" underline="true"/>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row btn-group-m-t">
                <div class="col-sm-10">
                    <fns:button btnCss="info" name="提交" id="ensure" icon="fa-check" clickFun="DeptInfoDlg.addSubmit()"/>
