...
UserInfoDlg.addSubmit = function () {
    ...
    if (!this.validatePwd()) {
        Soccer.error("两次密码输入不一致");
        return;
    }

    //提交信息
    var ajax = new $ax(Soccer.ctxPath + "/mgr/add", function (data) {
        Soccer.success("添加成功!");
        window.parent.MgrUser.table.refresh();
        UserInfoDlg.close();
    }, function (data) {
        Soccer.error("添加失败!" + data.responseJSON.message + "!");
    });
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Soccer.ctxPath + "/mgr/edit", function (data) {
        Soccer.success("修改成功!");
        ...
        Soccer.error("修改失败!" + data.responseJSON.message + "!");
    });
    ajax.set(this.userInfoData);
    ajax.start();
};
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(Soccer.ctxPath + "/mgr/changePwd", function (data) {
        Soccer.success("修改成功!");
    }, function (data) {
        Soccer.error("修改失败!" + data.responseJSON.message + "!");
    });
...
$(function () {
    Soccer.initValidator("userInfoForm", UserInfoDlg.validateFields);
